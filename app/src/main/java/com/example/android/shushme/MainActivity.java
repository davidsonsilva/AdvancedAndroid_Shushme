...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onAddPlaceButtonClicked(View view) {
        ...
        try {
            ...
            Log.e(TAG, String.format("GooglePlayServices Not avaliable [%s]", e.getMessage()));
            e.printStackTrace();
    ...
    protected void onActivityResult(int requetCode, int resultCode, Intent data){
        if (requetCode == PLACE_PICKER_REQUEST  && resultCode == RESULT_OK) {
            Place place = PlacePicker.getPlace(this, data);
            if (place == null) {
                Log.i(TAG, "No Places selected !");
                return;
            }
